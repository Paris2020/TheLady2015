...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
   <?php
    ...
    <?php
      //If the current view mode is a teaser
      if ($teaser){ 
    ?>
      <article class="event-node-teaser">
        ...
        <div class="event-venue">
          ...
          <h4 class="the-lady-headings-h4"><?php print $node->comment_count . ' comments'; ?></h4>
        </div>
      </article>
    <?php       
      }
      ...
      //If the view mode is a full page
      elseif ($page) {  
    ?>
      <article class="event-node-page">
        <h2 class="the-lady-headings-h2"><?php print $title; ?></h2>
          <div class="event-image">
            <?php print render($content['field_event_image']); ?>
          </div>
